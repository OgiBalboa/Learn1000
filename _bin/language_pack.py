...
class language_pack:
    ...
    def translate_to_english (self,word) :
        words = ["Hoş Geldiniz.... Kurulum için aşağıdaki bilgileri giriniz.",
                 ...
                 "Öğrendiğiniz kelime sayısı : ","TÜM BİLGİLERİNİN SIFIRLANACAK !",
                 ...
                 "Öğren !","Durumu Görüntüle","Quiz","Ayarlar","Çıkış",
                  "Quiz zorluğu seçiniz","Kelime : ","Çevirisi : ","Başlamak için Next'e basınız",
                 "Dinle","Kelime         Doğru Sayısı        Yanlış Sayısı        Durum       İlerleme",
                 ...
                 "Evet","Hayır","<Dil Seçiniz>","Almanca","İptal","0-10 dk","10-60 dk","60 dkdan fazla",
                 "<Süre Seçiniz>","Otomatik","Temel","Yaygın","Nadir","İleri","Onayla",
                 "Uygulama geliştirme aşamasındadır, lütfen öneri ve şikayetlerinizi ogibalboa@outlook.com adresinden ulaştırınız.",
                 "AYARLAR","        Dil :","Yeni","İyi","Kötü","Başarılı","Öğreniliyor","TEMEL KELİMELER",
                 "YAYGIN KULLANILAN","NADİR KULLANILAN","İLERİ SEVİYE","GENEL İLERLEYİŞ","Güncelleme !",

                 ]

        translations = ["Welcome.... Please enter the information below to continue.",
                        ...
                        "Select Quiz Difficulty","Word : ","Translation : ","Press 'Next' to start",
                        "Listen","Word           True Count        False Count        Status       Progress",
                        ...
                        "Yes","No","<Choose Language>","German","Cancel","0-10 mins","10-60 mins","more than 60 mins",
                        "<Choose Time>","Automatic","Basic","Common","Rare","Advantage","Submit",
                        "The app is on development phase, please send bugs and suggestions to us from ogibalboa@outlook.com.",
                        "SETTINGS","Language :","New","Good","Bad","Successful","Learning","BASIC WORDS",
                        "COMMON WORDS","RARE WORDS","ADVANCED WORDS","GENERAL PROGRESS","Update !",
